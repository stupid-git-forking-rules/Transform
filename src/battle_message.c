...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("Overwhelmed by its defeat...\p"),
#if B_WHITEOUT_MONEY >= GEN_4
    [STRINGID_PLAYERWHITEOUT2]                      = COMPOUND_STRING("Ditto scampered off to go find Chansey.{PAUSE_UNTIL_PRESS}"),
#else
    ...
    [STRINGID_AURAFLAREDTOLIFE]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s stats are boosted!"),
    ...
    [STRINGID_OMNIBOOST]                            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s stats were boosted!"),
};
