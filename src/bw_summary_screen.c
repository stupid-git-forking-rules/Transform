...
const u16 sSummaryScreen_ShinyPal_BW[]                      = INCBIN_U16("graphics/summary_screen/bw/tiles_shiny.gbapal");
...
static bool8 DecompressGraphics(void)
{
    ...
    case 8:
        ...
        {
            LoadPalette(sSummaryScreen_ShinyPal_BW, BG_PLTT_ID(0), 8 * PLTT_SIZE_4BPP);
        }
        else
        {
