...
const u32 gObjectEventPic_DittoAvatar[] = INCBIN_U32("graphics/pokemon/ditto/overworld.4bpp");
const u16 gObjectEventPal_DittoAvatar[] = INCBIN_U16("graphics/pokemon/ditto/overworld.gbapal");
